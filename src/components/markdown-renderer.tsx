...
// Extracted the `components` map outside the `MarkdownRenderer` component definition
// to prevent React from creating a new object on every render.
// When defined inline, React's reconciler forces a full unmount and remount of all
// markdown DOM elements on each update, causing severe rendering performance drops.
