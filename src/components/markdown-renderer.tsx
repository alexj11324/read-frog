...
// Bolt: Extracted `components` object outside the component to prevent recreation on every render,
// which was causing React to unnecessarily unmount and remount the entire markdown DOM tree.
